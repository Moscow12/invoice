                        ...
                        <form action='#' method='post' name='myForm' id='myForm' onsubmit="return validateForm();" enctype="multipart/form-data">
                                ...
                                <tr>
                                    <td colspan=2 style='text-align: right;'>
                                        <input type='submit' name='submit' id='submit' onclick="alert('The page requested to login, click Ok to continue');" value='SUBMIT' class='art-button'>
                                        <input type='reset' name='clear' id='clear' value='CLEAR' class='art-button'> 
												   <a href='bloodworkpage.php?BloodBank=BloodBankThisPage' class='art-button'>
